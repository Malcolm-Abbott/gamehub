...
export function Hero() {
    return (
        ...
        <div className="w-full bg-gradient-to-r from-purple-900/30 via-blue-900/30 to-pink-900/30 backdrop-blur-sm border border-purple-500/20 p-4 rounded-3xl overflow-hidden relative flex flex-col justify-center px-6 lg:px-12 py-12 lg:py-16 gap-3">
            <h1 className="hero-title text-4xl font-bold text-white flex items-center gap-2"><SparklesIcon className="w-8 h-8 text-purple-400" /><span className="text-4xl lg:text-6xl font-bold text-white"></span><span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Discover Amazing Games</span></h1>
