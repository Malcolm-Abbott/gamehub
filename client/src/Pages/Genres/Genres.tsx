...
export function Genres() {
    ...
    return (
        <div className="flex flex-col gap-6 lg:gap-8">
            <BackToHome />
            <SectionTitle icon={<Gamepad2Icon className="w-10 h-10 text-purple-400 lg:w-16 lg:h-16" aria-hidden="true" focusable="false" />} title={genre?.name ?? ""} addClass="text-3xl lg:text-5xl" gamesCount={genre?.games_count ?? 0} />
