...
| `Trailer.tsx` | 16:9 area, `<video>`, placeholder, centered overlay (`group`, symmetric **slate** play pill + `PlayIcon` from `sm+`, **purple/slate/blue** pill on hover) — see [`trailer.md`](./trailer.md) |
